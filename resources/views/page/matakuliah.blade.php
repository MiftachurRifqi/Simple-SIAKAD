      ...
      <div class="card card-info card-outline">
        <div class="card-header"> 
          <div class="card-tools">
            <a href="{{route('cetak_matakuliah')}}"  target="_blank" class="btn btn-info">Cetak Data <i class="fas fa-print"></i> </a>
            <a href="{{route('create_matakuliah')}}" class="btn btn-success">Tambah Data <i class="fas fa-plus-square"></i> </a>
          </div>
        </div>
        <div class="card-body">
