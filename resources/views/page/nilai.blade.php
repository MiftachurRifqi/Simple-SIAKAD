            ...
            <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    | <a href="#" class="delete" data-id="{{$item->id}}" data-nama="{{$item->nama_mahs}}"><i class="fa-regular fas fa-trash-alt" style="color:red"></i></a>
                  </td>
                </tr>
...
<script>
  $('.delete').click(function(){
    ...
    swal({
      title: "Yakin?",
      text: "Anda akan menghapus Nilai '"+nama+"'!",
      icon: "warning",
      buttons: true,
      dangerMode: true,
      })
      .then((willDelete) => {
        if (willDelete) {
          window.location = "/delete_nilai/"+nlid+""
